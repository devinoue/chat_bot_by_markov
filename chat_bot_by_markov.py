...
def make_response(word):
    ...
    # 「名詞」「形容詞」「動詞」は文章の意図を指していることが多いと想定し、視点の単語とする
    w1 = word
    res.append(w1)
...
while True:
    ...
    for w in wordlist:
        ...
        if hinshi in ["感動詞"]:
            print("Bot -> " + word)
            break
        # 品詞が名詞・形容詞・動詞の場合で、かつ辞書に単語が存在する場合は作文して返す
